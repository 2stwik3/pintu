...
def upload_im():
    try:
        ...
        display.grid()
        dn1 = tk.Label(windo, text='Original\ud83d\ude80 Image ', width=20, height=1, fg="white", bg="red",
                       font=('times', 22, ' bold '))
...
my_name = tk.Label(windo, text="©Developed by Sathwik", bg="blue", fg="white", width=67,
                   height=1, font=('times', 30, 'italic bold '))
my_name.place(x=00, y=785)
